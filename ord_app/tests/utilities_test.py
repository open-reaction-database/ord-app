...
"""Tests for ord_app.service_api.editor.utilities."""
...
#     response = test_client.post(f"/service_api/editor/validate/{message.DESCRIPTOR.name}", data=message.SerializeToString())
...
#         f"/service_api/editor/resolve_input", params={"input_string": "100 mL of 5.0uM sodium hydroxide in water"}
#     )
#     response.raise_for_status()
...
#         f"/service_api/editor/resolve_compound", json={"identifier_type": identifier_type, "identifier": data}
#     )
#     response.raise_for_status()
...
#     response = test_client.get(f"/service_api/editor/canonicalize_smiles", params={"smiles": smiles})
#     response.raise_for_status()
...
#     response = test_client.post(f"/service_api/editor/get_molblock", data=compound.SerializeToString())
#     response.raise_for_status()
